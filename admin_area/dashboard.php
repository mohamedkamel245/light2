            ...
            <div class="panel-body"><!-- panel-body begin -->
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        if($order_status=='pending'){
                                            ...
                                            echo $order_status='قيد الإنتظار';
                                            
                                        }else{
                                            
                                            echo $order_status='إكتمال';
                ...
                <div class="text-right"><!-- text-right begin -->
                    ...
                    <a href="index.php?view_orders"><!-- a href begin -->
                        ...
                        عرض جميع الطلبات <i class="fa fa-arrow-circle-right"></i>
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        <i class="fa fa-user"></i> <span> البريد الإلكتروني: </span> <?php echo $admin_email; ?> <br/>
                        <i class="fa fa-flag"></i> <span> بلد: </span> <?php echo $admin_country; ?> <br/>
                        <i class="fa fa-envelope"></i> <span> معلومات الاتصال </span> <?php echo $admin_contact; ?> <br/>
                    </div><!-- widget-content-expanded finish -->
                    
                    <hr class="dotted short">
                    
                    <h5 class="text-muted"> عني</h5>
