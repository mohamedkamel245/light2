    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> لوحة التحكم / تحرير الفئة
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-pencil fa-fw"></i> تحرير الفئة
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <div class="col-md-6">
                                    ...
                                    <?php if($cat_top == 'no'){}else{ echo "checked='checked'"; } ?> >

                                    <label> Yes </label>

                                    <input type="radio" name="cat_top" value="no" 
                                    
                                    <?php if($cat_top == 'no'){ echo "checked='checked'"; }else{} ?> >
                            ...
                            <input type="file" name="cat_image" class="form-control" >
                                ...
                                <img src="other_images/<?php echo $cat_image; ?>" width="70" height="70">
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="إرسال" name="update" type="submit" class="form-control btn btn-primary">
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if($run_cat){
                  ...
                  echo "<script>alert('تم تحديث الفئة الخاصة بك')</script>";
