...
<i class="fa fa-dashboard"> </i> لوحة التحكم / تحرير الكوبون
...
<i class="fa fa-money fa-fw"> </i> تعديل الكوبون
...
<label class="col-md-3 control-label"> حدد كوبون للمنتج  </label>
...
<option>حدد كوبون للمنتج </option>
...
<input type="submit" name="update" class=" btn btn-primary form-control" value=" تحديث الكوبون ">
...
echo "<script>alert('تم تحديث كوبون واحدة')</script>";
