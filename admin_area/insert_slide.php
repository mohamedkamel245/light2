    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> لوحة التحكم / إدراج الإعلانات
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> إدراج الإعلان
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input type="submit" name="submit" value="يقدم الآن" class="btn btn-primary form-control">
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if($count<4){
            ...
            echo "<script>alert('تم إدراج صورة الإعلان الجديد')</script>";
            
            echo "<script>window.open('index.php?view_slides','_self')</script>";
            
        }else{
            
           echo "<script>alert('لقد أدرجت بالفعل 4 إعلانات')</script>"; 
