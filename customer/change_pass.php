...
<form action="" method="post"><!-- form Begin -->
    ...
    <div class="text-center"><!-- text-center Begin -->
        ...
        <button type="submit" name="submit" class="btn btn-primary"><!-- btn btn-primary Begin -->
            ...
            <i class="fa fa-user-md"></i> تحديث الان
...
if(isset($_POST['submit'])){
    ...
    if($check_c_old_pass==0){
        ...
        echo "<script>alert('عذرًا ، كلمة المرور الحالية غير صالحة. حاول مرة اخرى')</script>";
    ...
    if($c_new_pass!=$c_new_pass_again){
        ...
        echo "<script>alert('عذرًا ، كلمة المرور الجديدة غير متطابقة')</script>";
    ...
    if($run_c_pass){
        ...
        echo "<script>alert('لقد تم تحديث كلمة السر الخاصة بك')</script>";
