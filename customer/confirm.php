       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="../index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/ecom-store-logo.png" alt="d-aw" class="hidden-xs">
                   <img src="images/ecom-store-logo-mobile.png" alt="d-aw" class="visible-xs">
               ...
               <div class="collapse clearfix" id="search"><!-- collapse clearfix Begin -->
                   ...
                   <form method="get" action="results.php" class="navbar-form"><!-- navbar-form Begin -->
                       ...
                       <div class="input-group"><!-- input-group Begin -->
                           ...
                           <button type="submit" name="search" value="بحث" class="btn btn-primary"><!-- btn btn-primary Begin -->
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <h1 align="center"> يرجى تأكيد الدفع الخاص بك</h1>
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> المبلغ المرسل: </label>
                          ...
                          <input type="text" class="form-control" name="amount_sent" value="<?php echo $due_amount; ?> ريال " required>
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> اختر طريقة الدفع: </label>
                          ...
                          <select name="payment_mode" class="form-control"><!-- form-control Begin -->
                              ...
                              <option> الدفع عند الإستلام </option>
                       ...
                       <div class="text-center"><!-- text-center Begin -->
                           ...
                           <button class="btn btn-primary btn-lg" name="confirm_payment"><!-- tn btn-primary btn-lg Begin -->
                               ...
                               <i class="fa fa-user-md"></i> تأكيد الدفع
                   ...
                   <?php 
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        if($run_pending_order){
                            ...
                            echo "<script>alert('شكرًا لك على الشراء ، سيتم إكمال طلباتك خلال 24 ساعة من العمل')</script>";
