<div class="box"><!-- box Begin -->
  ...
  <div class="box-header"><!-- box-header Begin -->
      ...
      <center><!-- center Begin -->
          ...
          <p class="lead"> لديك بالفعل حسابنا ..؟ </p>
...
if(isset($_POST['login'])){
    ...
    if($check_customer==0){
        ...
        echo "<script>alert('بريدك الإلكتروني أو كلمة المرور خاطئة')</script>";
    ...
    if($check_customer==1 AND $check_cart==0){
       ...
       echo "<script>alert('لقد سجلت الدخول')</script>"; 
