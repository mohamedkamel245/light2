        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!--  col-sm-6 col-md-3 Begin -->
                ...
                <ul><!-- ul Begin -->
                    ...
                    <li><a href="my_account.php">حسابي</a></li>
                </ul><!-- ul Finish -->
                ...
                <ul><!-- ul Begin -->
                    ...
                    <?php 
                           ...
                           if(!isset($_SESSION['customer_email'])){
                              ...
                              echo"<a href='my_account.php?my_orders'>حسابي</a>"; 
                    ...
                    <li>
                        ...
                        <?php 
                           ...
                           if(!isset($_SESSION['customer_email'])){
                              ...
                              echo"<a href='my_account.php?edit_account'>تحرير الحساب</a>"; 
...
<div id="copyright"><!-- #copyright Bgein -->
    ...
    <div class="container"><!-- container Bgein -->
        ...
        <div class="col-md-6"><!-- col-md-6 Bgein -->
            ...
            <p class="pull-lrft">&copy; 2020 Fox M-M</p>
            
        </div><!-- col-md-6 Finish -->
        
        <div class="col-md-6"><!-- col-md-6 Bgein -->
            
            <p class="pull-right">hemf by: <a href="#">Fox-M</a></p>
